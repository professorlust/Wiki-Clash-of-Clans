...
public class DescribeBuildingTrapGiantBombActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_describe_building_trap_giant_bomb);
...
//        Initialisation des vues avec les données récupérées
        ...
        rearmcost.setText(property[4] + " or");
...
//        Attribution des Listeners
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_describe_building_trap_giant_bomb, menu);
        return true;
    }
