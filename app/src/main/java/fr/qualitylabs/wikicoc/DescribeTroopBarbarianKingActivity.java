...
public class DescribeTroopBarbarianKingActivity extends AppCompatActivity {

    Toolbar toolbar;

    BarbarianKing troop = new BarbarianKing();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_describe_troop_barbarian_king);
...
//        Récupération des vues
        ...
        abilitySpeed = (TextView) findViewById(R.id.ability_speed);
        abilityUnits = (TextView) findViewById(R.id.ability_units);
        abilityTime = (TextView) findViewById(R.id.ability_time);

//        Récupère les extras
        troop = (BarbarianKing) getIntent().getSerializableExtra("troop");
...
//
        ...
        abilitySpeed.setText(ability[3]);
        abilityUnits.setText(ability[4]);
        abilityTime.setText(ability[5]);
...
//        Attribution des Listeners
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_describe_troop_barbarian_king, menu);
        return true;
    }
