...
public class DescribeSpellHasteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_describe_spell_haste);
...
//        Attribution des Listeners
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_describe_spell_haste, menu);
        return true;
    }
